        ...
        <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              Get role-specific questions, expand answers when needed, dive deeper into core concepts, and organize everything your way — from prep to pro. Your ultimate interview toolkit is here.
              </p>
